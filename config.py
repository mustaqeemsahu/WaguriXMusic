...
class Config:
    ...
    def __init__(self):
        ...
        self.SUPPORT_CHANNEL: str = getenv(
            "SUPPORT_CHANNEL", "https://t.me/sahu_bot_support")
        self.SUPPORT_CHAT: str = getenv("SUPPORT_CHAT", "https://t.me/MahiruMusic_chat")
        ...
        self.START_IMG: str = getenv(
            "START_IMG", "https://files.catbox.moe/ichom4.jpg")  # Start command image
